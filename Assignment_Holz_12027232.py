...
class Block:
    ...
    def right_rotation(self, rotation_options):
        ...
        self.rotation = (self.rotation + 1) % (self.possible_rotations-1)
...
class Game(BaseGame):
    def run_game(self):
        ...
        while True:
            ...
            print("CurrentBlock X: " + (str(current_block.x)) + ", Y: " + str(current_block.y))
    ...
    def remove_complete_line(self):
        nr_rows_removed = 0
        print("height: " + str(self.board_height))
    ...
    def calculate_new_level(self, score):
        ...
        self.score_level = math.floor(score / 300)
